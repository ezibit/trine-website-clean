    ...
    tracks: [
      {
        ...
        duration: '4:23',
        preview: '/api/placeholder/audio/preview1.mp3',
      },
      {
        id: 2,
        title: 'Learning Phase',
        duration: '5:17',
        preview: '/api/placeholder/audio/preview2.mp3',
      },
      {
        id: 3,
        title: 'Neural Cascade',
        duration: '6:45',
        preview: '/api/placeholder/audio/preview3.mp3',
      },
      {
        id: 4,
        title: 'Convergence',
        duration: '4:56',
        preview: '/api/placeholder/audio/preview4.mp3',
      },
    ],
    streamingLinks: {
      spotify: 'https://open.spotify.com/album/neural-cascade',
